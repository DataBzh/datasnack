...
library(magrittr)
library(ggmap)
cotes <- read.csv("pack.master.cotes-darmor.theatre.csv", stringsAsFactors = FALSE)[,1:3]
fin <- read.csv("pack.master.finistere.theatre.csv", stringsAsFactors = FALSE)[,1:3]
ill <- read.csv("pack.master.ille-et-vilaine.theatre.csv", stringsAsFactors = FALSE)[,1:3]
mor <- read.csv("pack.master.morbihan.theatre.csv", stringsAsFactors = FALSE)[,1:3]
