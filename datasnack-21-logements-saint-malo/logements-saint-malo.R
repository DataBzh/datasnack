...
library(tidyr)
library(ggplot2)
stmalo <- read_csv2("https://www.data.gouv.fr/s/resources/statistiques-logements/community/20150903-104236/35288-STMALO-Logements.csv")
stmalo <- gather(stmalo, key = type, value = volume, 3:5)
names(stmalo)[1] <- "Date"
